...
import { buildUriQueryOrFragmentArbitrary } from './_internals/builders/UriQueryOrFragmentArbitraryBuilder.ts';
import { SizeForArbitrary } from './_internals/helpers/MaxLengthFromMinLength.ts';
 ...
 * @public
 */
export function webFragments(constraints: WebFragmentsConstraints = {}): Arbitrary<string> {
